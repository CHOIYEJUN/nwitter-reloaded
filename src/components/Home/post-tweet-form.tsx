...
import { DBservice, auth } from "../../../fireBase.ts";
import { collection, addDoc, updateDoc } from "firebase/firestore";
import { storageService } from "../../../fireBase.ts";
...
export default function PostTweetForm() {
    ...
    const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            setLoading(true);
            const tweetDoc = await addDoc(collection(DBservice, "tweets"), {
                tweet,
                createdAt: Date.now(),
                image: "",
                userId: user?.uid,
            ...
            if(file) {
                ...
                const refUrl = await getDownloadURL(result.ref);
